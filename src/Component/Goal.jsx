...
export default function Goal() {
  ...
  return (
    <div className="bg-blue-500 w-full h-full transition-all duration-300">
      <div 
        className="bg-[#C8DBFA] h-[90vh] flex flex-col items-center justify-center bg-opacity-80 p-6 md:p-8 shadow-inner group-hover:shadow-xl"
        onMouseEnter={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
      >
        <div ref={logoRef} className="inline-flex z-10 items-center gap-2 px-4 py-1 scale-[2] mb-5 text-sm font-semibold rounded-full shadow-sm bg-purple-100 text-purple-700">
